...
public class Atm {
	...
	public void setPin(int pin) {
	 ...
	 public String pincharge(int accountno,int oldpin,int newpin,int confirmpin)
	 {
		 if(accountno !=getAccountno())
		 {
		 ...
		 {
			 return"newpin and confirmpin should be match:";
		 }
		 setPin(confirmpin);
		 ...
		 public static void main(String[] args) {
			...
			String result=a.pincharge(accountno, oldpin, newpin, confirmpin);
